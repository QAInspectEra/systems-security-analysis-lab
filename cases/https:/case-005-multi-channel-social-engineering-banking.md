...
1.
Attacker obtains victim’s email and phone number
2.
Attacker triggers legitimate banking process
3.
Bank system sends authenticated email
4.
Email includes attacker-controlled phone number
5.
Attacker sends matching SMS
6.
Victim is encouraged to call support
7.
Attack continues via phone (vishing)
